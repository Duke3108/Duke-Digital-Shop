  ...
  return (
    <div className='relative w-screen h-screen'>
      ...
      <div className='absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center'>
        <div className='p-8 bg-transparent border-2 border-white/20 backdrop-blur-[10px] flex flex-col items-center rounded-md min-w-[500px] shadow-[0_0_10px_rgba(0,0,0,0.2)] text-white'>
          ...
          <Button
            ...
            fw
          />
          <div className='flex items-center justify-between w-full my-4 text-sm'>
